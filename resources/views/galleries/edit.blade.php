...
<div class="bg-white rounded-xl shadow p-6 max-w-lg mx-auto">
    ...
    <form action="{{ route('galleries.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" value="{{ $gallery->title }}" class="w-full border border-gray-300 rounded px-3 py-2" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <img src="{{ asset('storage/'.$gallery->image) }}" class="w-full h-32 object-cover rounded-md mb-2">
        </div>

        <!-- Ganti Foto (Opsional) -->
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Ganti Foto (Opsional)</label>
            <input type="file" name="image" id="imageInput" class="w-full border border-gray-300 rounded px-3 py-2" accept="image/jpeg,image/png,image/jpg,image/gif">
